...
public class POIUtil {
     ...
     * @return Workbook
     */
    public static Workbook createExcelFile(List<String> titleList, List<List<String>> dataList, List<Integer> widthList, String sheetName, String extension) {
        // 1. 创建workbook
        ...
        createSheetData(workbook, titleList, dataList, widthList, sheetName);

        return workbook;
    }

    public static void createSheetData(Workbook workbook, List<String> titleList, List<List<String>> dataList, List<Integer> widthList, String sheetName){
        ...
        if (workbook != null) {
            ...
            row0.setHeight((short)(25*15.625));

            for (int i = 0; i < titleList.size(); i++) {
                Cell cell = row0.createCell(i);
                cell.setCellValue(titleList.get(i).trim());
                // 设置单元格格式
                ...
                if (widthList != null && widthList.size() > i){
                    // 设置列宽
